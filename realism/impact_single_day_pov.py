...
def main(config_path):
    ...
    global ONLY_EXECUTED, CLIPPED_START_TIME, CLIPPED_FINISH_TIME, PLOT_DATA, CACHE_FILE, USE_CACHE, PLOT_PARAMS_DICT, SPREAD_PLOT_LOG_SCALE, ORDERBOOK_IMBALANCE_PLOT_LOG_SCALE, COMPUTE_IMPACT_STATS
